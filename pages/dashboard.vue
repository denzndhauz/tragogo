  ...
  <div class="h-screen flex flex-col bg-neutral-50">
    ...
    <div class="h-[60%] relative">
      ...
      <button 
        ...
        class="absolute top-4 right-20 bg-white text-ocean-600 shadow-md p-3 rounded-full hover:bg-neutral-50 active:scale-[0.95] transition-all z-10 tap-target"
        ...
        <div v-if="activeTab === 'family'" class="p-4">
          ...
          <div v-else class="space-y-2">
            ...
            <button 
              ...
              class="w-full text-left list-item rounded-xl hover:bg-neutral-100 transition-colors active:bg-neutral-200 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <div 
                v-if="user?.profileIcon" 
              ...
              <div class="flex-1 min-w-0">
                <div class="font-medium text-neutral-900 truncate">{{ user?.name }} (You)</div>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <div class="font-medium text-neutral-900 truncate">{{ member.user?.name }}</div>
                <div class="text-xs text-neutral-500">
        ...
        <div v-if="activeTab === 'locations'" class="p-4 space-y-2">
          ...
          <div v-else class="space-y-2">
            <button
              ...
              class="w-full text-left list-item rounded-xl hover:bg-neutral-100 transition-colors active:bg-neutral-200"
            >
    ...
    <div v-if="showInviteModal" class="fixed inset-0 bg-black/50 flex items-end z-50" @click.self="showInviteModal = false">
      <div class="bottom-sheet animate-slide-up w-full">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-xl font-bold text-neutral-900">Invite Family Member</h2>
        ...
        <p class="text-neutral-600 mb-6">Feature coming soon! You'll be able to invite family members via email, QR code, or invitation link.</p>
        <button @click="showInviteModal = false" class="btn-primary">Got it</button>
      </div>
    </div>

    <!-- Location Selector Modal - Full Screen -->
    <div v-if="showLocationModal" class="fixed inset-0 bg-white z-50 flex flex-col">
      <!-- Header -->
      <div class="flex-shrink-0 safe-top bg-white border-b border-neutral-200 px-6 py-4">
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-2xl font-bold text-neutral-900">Add Location</h2>
      ...
      <div class="flex-1 overflow-y-auto smooth-scroll">
        ...
        <div class="px-6 py-6 border-b border-neutral-200">
          <label class="block text-sm font-semibold text-neutral-900 mb-2">Location Name</label>
          <input 
        ...
        <div class="px-6 py-6 border-b border-neutral-200">
          <label class="block text-sm font-semibold text-neutral-900 mb-3">Location Type</label>
        ...
        <div class="px-6 py-6 border-b border-neutral-200">
          ...
          <div v-else class="p-4 bg-warning-50 border border-warning-200 rounded-2xl">
            ...
            <p class="text-xs text-warning-700">Please enable tracking to mark your current location.</p>
          </div>
        </div>

        <!-- Suggested/Recent Locations -->
        <div v-if="filteredLocationSuggestions.length > 0" class="px-6 py-6 border-b border-neutral-200">
          <p class="text-sm font-semibold text-neutral-900 mb-3">Popular Locations</p>
          <div class="space-y-2">
            <button
              ...
              :class="[
                ...
                locationName === suggestion 
                  ...
                  : 'bg-neutral-50 border-neutral-200 hover:border-ocean-300'
              ]"
            >
              <div class="font-medium text-neutral-900">{{ suggestion }}</div>
            </button>
          </div>
        </div>
      ...
      <div class="flex-shrink-0 flex gap-3 px-6 py-4 border-t border-neutral-200 safe-bottom bg-white">
        <button 
          ...
          class="flex-1 py-3 bg-neutral-100 text-neutral-900 font-semibold rounded-xl hover:bg-neutral-200 transition-colors"
        >
          Cancel
        </button>
        <button 
